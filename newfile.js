...
(function () {
        ...
        return `
            ...
            <div class="chatbox">
                ...
                <div class="overlay">
                    <div class="options">
                        ...
                        <div class="color-picker-container">
                         ...
                         <button class="options-body-btn">
                    <span class="icon">
                        <svg viewBox="0 0 24 24" width="1em" height="1em"><path fill="none" stroke="${config.color}" stroke-linecap="round" stroke-linejoin="round" 
                        stroke-width="2" d="M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9m4.3 13a1.94 1.94 0 0 0 3.4 0M4 2C2.8 3.7 2 5.7 2 8m20 0c0-2.3-.8-4.3-2-6"></path></svg>
                    </span>
                    Play the sounds
                </button>
                ...
                <button class="options-body-btn">
                    <span class="icon">
                        <svg viewBox="0 0 24 24" width="1em" height="1em">
                            <path fill="none" stroke="${config.color}" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2" d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4m4-5l5 5l5-5m-5 5V3">
                            </path>
                        </svg>
                    </span>
                    Download transcript
                ...
                <button class="options-body-btn">
                    <span class="icon">
                        <svg viewBox="0 0 24 24" width="1em" height="1em">
                            <g fill="none" stroke="${config.color}" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2">
                                <path
    ...
    function initializeWidget() {
        ...
        function toggleOptions() {
            ...
            optionsPanel.style.height = optionsPanel.style.height === '' ? '' : '';
        }

        function toggleExpand() {
            chatbox.style.width = chatbox.style.width === '' ? '500px' : '';
            chatbox.style.height = chatbox.style.height === '' ? '650px' : '';
        }
